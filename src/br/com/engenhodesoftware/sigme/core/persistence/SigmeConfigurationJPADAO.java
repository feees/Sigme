...
import br.com.engenhodesoftware.sigme.core.domain.SigmeConfiguration_;
...
public class SigmeConfigurationJPADAO extends BaseJPADAO<SigmeConfiguration> implements SigmeConfigurationDAO {
	...
	/** @see br.com.engenhodesoftware.sigme.core.persistence.SigmeConfigurationDAO#retrieveCurrentConfiguration() */
	@Override
