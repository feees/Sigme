package br.com.engenhodesoftware.util.jms;
 ...
 * 
 * Processing the events actually means raising a CDI event to be observed by some application-specific class with the @InBackground
 * annotation.
 * 
