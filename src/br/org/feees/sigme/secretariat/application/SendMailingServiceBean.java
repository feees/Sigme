...
import br.org.feees.sigme.secretariat.persistence.EmailDeliveryDAO;
import br.org.feees.sigme.secretariat.persistence.MailingDAO;
 ...
 * @see br.org.feees.sigme.secretariat.application.SendMailingService
 */
@Stateless
...
public class SendMailingServiceBean extends ListingServiceBean<EmailDelivery> implements SendMailingService {
	...
	/** @see br.org.feees.sigme.secretariat.application.SendMailingService#retrieveSingleMailingList() */
	@Override
	public MailingList retrieveSingleMailingList() {
		return mailingListDAO.retrieveSingleMailingList();
	}

	/** @see br.org.feees.sigme.secretariat.application.SendMailingService#sendMailing(br.org.feees.sigme.secretariat.domain.Mailing) */
	...
	/** @see br.org.feees.sigme.secretariat.application.SendMailingService#retrieveSentMailing(java.lang.String) */
	@Override
	...
	/** @see br.org.feees.sigme.secretariat.application.SendMailingService#isMailingDelivered(br.org.feees.sigme.secretariat.domain.Mailing) */
	@Override
	...
	/** @see br.org.feees.sigme.secretariat.application.SendMailingService#countTotalDeliveries(br.org.feees.sigme.secretariat.domain.Mailing) */
	@Override
	public long countTotalDeliveries(Mailing mailing) {
		return emailDeliveryDAO.countDeliveriesFromMailing(mailing);
	}

	/** @see br.org.feees.sigme.secretariat.application.SendMailingService#countPendingDeliveries(br.org.feees.sigme.secretariat.domain.Mailing) */
	@Override
	public long countPendingDeliveries(Mailing mailing) {
		return emailDeliveryDAO.countPendingDeliveriesFromMailing(mailing);
	}

	/** @see br.org.feees.sigme.secretariat.application.SendMailingService#countSentDeliveries(br.org.feees.sigme.secretariat.domain.Mailing) */
	@Override
	public long countSentDeliveries(Mailing mailing) {
		return emailDeliveryDAO.countSentDeliveriesFromMailing(mailing);
	}

	/** @see br.org.feees.sigme.secretariat.application.SendMailingService#countErrorDeliveries(br.org.feees.sigme.secretariat.domain.Mailing) */
	@Override
