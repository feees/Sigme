...
public class ManageManagementServiceBean extends CrudServiceBean<Management> implements ManageManagementService {

	/** Serialization id. */
	private static final long serialVersionUID = 1L;

	/** The logger. */
	private static final Logger logger = Logger.getLogger(ManageManagementServiceBean.class.getCanonicalName());
