...
@Stateless
@RolesAllowed({ "USER" })
public class ManageMailingListsService extends CrudService<MailingList> implements ManageMailingListsServiceLocal {
	/** Serialization id. */
	private static final long serialVersionUID = 1L;

	/** The logger. */
	private static final Logger logger = Logger.getLogger(ManageMailingListsService.class.getCanonicalName());
